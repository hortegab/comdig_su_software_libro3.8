...
class Lab_total(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab_total", catch_exceptions=True)
        ...
        self.MiconstellationObject3 = MiconstellationObject3 = digital.constellation_calcdist(const[3].points(), numpy.arange(len(const[3].points())),
        4, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        self.MiconstellationObject2 = MiconstellationObject2 = digital.constellation_calcdist(const[2].points(), numpy.arange(len(const[2].points())),
        4, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        self.MiconstellationObject1 = MiconstellationObject1 = digital.constellation_calcdist(const[1].points(), numpy.arange(len(const[1].points())),
        4, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        self.MiconstellationObject0 = MiconstellationObject0 = digital.constellation_calcdist(const[0].points(), numpy.arange(len(const[0].points())),
        4, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        ...
        self.top_layout.addWidget(_run_stop_check_box)
