...
class Lab_total(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.MiconstellationObject = MiconstellationObject = digital.constellation_calcdist(Constelacion, ,
        ...
        self._NodB_win = RangeWidget(self._NodB_range, self.set_NodB, 'Ch_No(dB)', "counter", float, QtCore.Qt.Horizontal)
        ...
        self._Ch_Jitter_win = RangeWidget(self._Ch_Jitter_range, self.set_Ch_Jitter, 'Ch_Jitter', "counter", float, QtCore.Qt.Horizontal)
        ...
        self._Ch_Frec_offset_win = RangeWidget(self._Ch_Frec_offset_range, self.set_Ch_Frec_offset, 'Ch_Frec_offset (Hz)', "counter", float, QtCore.Qt.Horizontal)
        ...
        self._Ch_Delay_win = RangeWidget(self._Ch_Delay_range, self.set_Ch_Delay, 'Ch_Delay', "counter", int, QtCore.Qt.Horizontal)
        ...
        self._tap7_win = RangeWidget(self._tap7_range, self.set_tap7, 'tap7', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap6_win = RangeWidget(self._tap6_range, self.set_tap6, 'tap6', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap5_win = RangeWidget(self._tap5_range, self.set_tap5, 'tap5', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap4_win = RangeWidget(self._tap4_range, self.set_tap4, 'tap4', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap3_win = RangeWidget(self._tap3_range, self.set_tap3, 'tap3', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap2_win = RangeWidget(self._tap2_range, self.set_tap2, 'tap2', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap1_win = RangeWidget(self._tap1_range, self.set_tap1, 'tap1', "slider", float, QtCore.Qt.Horizontal)
        ...
        self._tap0_win = RangeWidget(self._tap0_range, self.set_tap0, 'tap0', "slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, M, 1000000))), True)
        self.analog_agc2_xx_0 = analog.agc2_cc(1e-1, 1e-2, 1.0, 1.0)
        self.analog_agc2_xx_0.set_max_gain(65536)
        self._SymbTune_range = Range(0, 1000, 1, 2, 200)
        self._SymbTune_win = RangeWidget(self._SymbTune_range, self.set_SymbTune, 'SymbTunning', "counter", int, QtCore.Qt.Horizontal)
